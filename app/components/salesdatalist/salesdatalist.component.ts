...
export class SalesdatalistComponent implements OnInit {
  ...
  constructor(private DataServiceService: DataServiceService, private  SpinalService:  SpinalService ) { }
  ...
  getData = async () => {
     ...
     console.log('listing',this.listingsales);
  ...
  getbyRegion = () => {
    console.log('categort', this.Region)
    if(this.Region ){
